...
void setup() {
  ...
  Rtc.Begin();
#if defined(ESP8266)
  Wire.begin(5, 4); // i2c bus is opposite to standard for ESP
#endif
...
#endif
  delay(2000); // allow user 2 seconds to press GPIO0 to clear EPROM if in an invlaid state, e.g. bad WiFi config. 
  ...
  server.begin();  // begins REST or WWW server?
